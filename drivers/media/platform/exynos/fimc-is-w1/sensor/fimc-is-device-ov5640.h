...
struct fimc_is_sensor_cfg config_ov5640[] = {
        FIMC_IS_SENSOR_CFG(320, 240, 120, 2, 0),
        FIMC_IS_SENSOR_CFG(640, 480, 90, 2, 1),
        FIMC_IS_SENSOR_CFG(1280, 720, 60, 2, 2),
        FIMC_IS_SENSOR_CFG(1920, 1080, 30, 2, 3),
        FIMC_IS_SENSOR_CFG(2560, 1920, 15, 2, 4),
